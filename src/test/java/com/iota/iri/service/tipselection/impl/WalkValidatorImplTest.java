...
public class WalkValidatorImplTest {
    ...
    public void shouldPassValidation() throws Exception {
        ...
        Mockito.when(ledgerService.isBalanceDiffConsistent(tangle, snapshotProvider, new HashSet<>(), new HashMap<>(), hash))
                .thenReturn(true);
    ...
    public void belowMaxDepthOnGenesis() throws Exception {
        ...
        Mockito.when(ledgerService.isBalanceDiffConsistent(tangle, snapshotProvider, new HashSet<>(), new HashMap<>(), tx.getHash()))
                .thenReturn(true);
    ...
    public void dontMarkWrongTxsAsBelowMaxDepth() throws Exception {
        ...
        Mockito.when(ledgerService.isBalanceDiffConsistent(tangle, snapshotProvider, new HashSet<>(), new HashMap<>(), tx4.getHash()))
                .thenReturn(true);
        Mockito.when(ledgerService.isBalanceDiffConsistent(tangle, snapshotProvider, new HashSet<>(), new HashMap<>(), tx2.getHash()))
                .thenReturn(true);
